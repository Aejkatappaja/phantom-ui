...
- **SSR pre-hydration CSS**: For Next.js, Nuxt, SvelteKit, Remix, and Qwik, it adds `import "@aejkatappaja/phantom-ui/ssr.css"` to your layout file to prevent content flash before hydration (see [SSR Frameworks](/phantom-ui/frameworks/ssr/#pre-hydration-css)).
